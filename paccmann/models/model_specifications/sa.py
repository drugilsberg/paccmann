...
from ...layers import (
    dense_attention_layer, embedding_layer, sequence_attention_layer
)


def sa_fn(features, labels, mode, params):
    """
    ...
    Args:
        ...
        - params: parameters for the model (<dict<string, object>>).
            Mandatory parameters are:
                ...
                - smiles_vocabulary_size: size of the tokens vocabulary (<int>).
                - smiles_embedding_size: dimension of tokens' embedding (<int>).
                - smiles_attention_size: (<int>). The size of attentive units.
            Optional parameters for the model:
                ...
                - positional_encoding: Whether positional encoding is applied.
                    Choose (<string>, None) and string from {learned, sinusoidal}.
            Example params:
            ```
            {  
    ...
    encoded_smiles, smiles_attention_coefficients = sequence_attention_layer(
            embedded_tokens, smiles_attention_size,
